...
public class FriendList {
    ...
    public FriendList(Controller controller, String username, JFrame frame) {
...
//      renderMessageLog();
    ...
    private void renderHeader(){
        ...
        north.add(new JLabel("FRIENDS",20,GUIConstants.blue,Font.BOLD),BorderLayout.WEST);
        ...
        ArrayList<MessageViewerUser> friends = currentUser.getFriends();

        // Create the table model and table
//        DefaultTableModel model = new DefaultTableModel(new Object[]{"friends"}, 0);
//        JTable table = new JTable(model);

//        // Populate the table with map data
//        for (MessageViewerUser friend : friends) {
//            model.addRow(new Object[]{friend.getName()});
//        }

        for (MessageViewerUser friend : friends) {
            panel.add(Box.createVerticalStrut(7));
            panel.add(new FriendsUI(friend,controller), BorderLayout.EAST);
        }
